...
**Scripts used**
Scripts used for scRNA-seq quality control, integration, annotation and UMAP generation are available here.
...
**Scripts used**
Scripts used for cNMF analysis, program annotation, statistical testing and heatmap generation are available here.
...
**Scripts used**
Scripts used for Memento differential gene expression analysis and the calculation of urban–rural differences in the LPS response are available here.
...
**Scripts used**
Scripts used for cell-type-specific pseudobulk generation, edgeR differential accessibility analysis and calculation of urban–rural differences in the LPS response are available here.
